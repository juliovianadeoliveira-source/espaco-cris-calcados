...
(function(){
  ...
  document.addEventListener('DOMContentLoaded',()=>{read();inject();render();const grid=document.getElementById('grid');if(grid)new MutationObserver(enhance).observe(grid,{childList:true});enhance()});
})();
